...
">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Detail Leger Siswa</h1>
                    </div><!-- /.col -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="margin-bottom: 6rem; margin-top: 1rem;">
                            <h3 class="mt-3 ms-4">Kelas XII RPL 1</h2>
                                <div class="row">
                                    <div class="col-6" style="
                                    padding-left: 35px;
                                ">
                                        <form action="/uploadNilai" method="post" enctype="multipart/form-data">

                                            {{-- <select class="form-select main-color w-25"
                                                aria-label="Default select example">
                                                <option class="bi-select" value="smt1">Semester 1</option>
                                                <option class="bi-select" value="smt2">Semester 2</option>
                                            </select> --}}

                                            {{ csrf_field() }}
                                            <input style="border:1px solid black; margin-bottom: 10px" type="file"
                                                name="excel" accept=".xlsx">
                                ...
                                width: 47%;">
                                            <input type="text" id="searchSiswa" class="form-control"
                                                placeholder="Ketikkan sesuatu" aria-label="Ketikkan sesuatu"
                                    ...
                                    <table id="dataSiswa" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $s->nama }}</td>
                                                <td>{{ $s->nisn }}</td>
                                                @foreach (json_decode($s->nilai) as $item)
                                                <td>{{ $item }}</td>
                                                @endforeach
                                            </tr>
                                            @endforeach
