        ...
        <div class="row">
          <div class="col-12">
            <div class="card" style="margin-bottom: 6rem; margin-top: 1rem;">
              <h3 class="mt-3 ms-4">Data Leger Siswa</h2>
                <div class="row">
                  <div class="col-6"><button type="submit" class="btn btn-primary"
                      style="background-color: #198754;border: none;margin-left: 23px;margin-top: 3px;"><svg style="
                              margin-right: 5px;
                              height: 14px;
                              width: 14px;
                              margin-top: -3px;
                    ...
                    <tbody>
                      <tr>
                        ...
                        " width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="detail_leger" style="color:white; text-decoration:none;">Detail</a></button></td>
                      </tr>
                      <tr>
                        <td>2</td>
                        <td>XII RPL 2</td>
