            ...
            <div class="row">
                <div class="col-12">
                  <div class="card" style="margin-bottom: 6rem; margin-top: 1rem;">
                    <h3 class="mt-3 ms-4">Mata Pelajaran</h3>
                        <div class="row">
                            <div class="col-6"><button data-toggle="modal" data-target="#modal-add-mapel "type="submit" class="btn btn-primary" style="background-color: #198754;border: none;margin-left: 23px;margin-top: 3px;"><svg style="
                              margin-right: 5px;
                              height: 14px;
                              width: 14px;
                              margin-top: -3px;
                          " width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-6 d-flex justify-content-end" style="padding-right: 28px;">
                              <button data-toggle="modal" data-target="#modal-kurikulum "type="submit" class="btn btn-primary main-color mr-2" style="border: none; height:72%">Master Kurikulum</button>
                                <div class="input-group mb-3" style="
                                width: 47%;">
                                <div class="category-filter mr-2">
                                  <select id="categoryFilter" class="form-control">
                                    <option value="1">Merdeka</option>
                                    <option value="2">Ytta</option>
                                    <option value="3">Terjajah</option>
                                  </select>
                                </div>
                    ...
                    <div class="card-body" style="margin-top: -17px;">
                      <table id="dataMapel" class="table table-bordered table-striped">
                        <thead>
                        <tr>
                      ...
                      <a onclick="return confirm('Ingin menghapus data mapel {{ Str::title($m->nama_pelajaran) }} ?')" href="/deleteMapel/{{ $m->id }}" style="text-decoration: none">
                      <button type="submit" style="width: 30px;" class="btn btn-danger d-flex justify-content-center">
