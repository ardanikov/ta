            ...
            <div class="row">
                <div class="col-12">
                  <div class="card" style="margin-bottom: 6rem; margin-top: 1rem;">
                    <h3 class="mt-3 ms-4">Data Guru</h3>
                        <div class="row">
                    ...
                    margin-top: -17px;">
                      <table id="dataSiswa" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <td>0228193819392897543</td>
                          <td>Rr Henning Gratyanis, S.pd</td>
                          <td class="text-center">PWPB, PKK</td>
                  ...
                  " class="btn btn-danger d-flex justify-content-center">
                        ...
                        <tr>
                          ...
                          <td>0228199293392897081</td>
                          <td>Krismawandi Nugroho, S.pd</td>
                          <td class="text-center">BJWA</td>
                          <td class="d-flex justify-content-center"><div class="row">
                            <div class="col-6 px-0 d-flex justify-content-center">
                        <a href="javascript:void(0)" style="color:white; text-decoration:none;">
                      <button type="button" style="
