            ...
            <div class="row">
                <div class="col-12">
                  <div class="card" style="margin-bottom: 6rem; margin-top: 1rem;">
                    <h3 class="mt-3 ms-4">Data Petugas</h3>
                        <div class="row">
                    ...
                    margin-top: -17px;">
                      <table id="dataSiswa" class="table table-bordered table-striped">
                        ...
                        <tr>
                          ...
                          <td class="text-center"><img class="photoThumbnail" src="{{ asset('img/profiles') }}/frizzyardhani-after.jpg" alt=""></td>
                          <td class="text-center">Frizzy Ardhani</td>
                          <td class="text-center">Ardanikova</td>
                          <td class="text-center">Admin</td>
                          <td class="d-flex justify-content-center"><div class="row">
                            <div class="col-6 px-0 d-flex justify-content-center">
                        <a href="{{ route('detail_admin') }}" style="color:white; text-decoration:none;">
                      <button type="button" style="
                      width: 30px;
                  " class="btn btn-warning d-flex justify-content-center">
                        <span class="fa fa-edit text-white ml-1"></span>                        
                    </button></a>
                </div>
